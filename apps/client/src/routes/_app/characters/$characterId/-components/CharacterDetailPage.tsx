...
import { CharacterForm } from "@/features/shared/characters/CharacterForm";
import { CharacterGalleryPanel } from "@/features/shared/characters/CharacterGalleryPanel";
import { avatarSrc } from "@/lib/avatar-url";
import { LinkedLorebooksPanel } from "@/features/shared/lorebooks/CharacterLinkedLorebooks";
import {
  useCharacter,
  useDeleteCharacter,
...
import classes from "@/features/shared/avatarEntityDetailPage.module.css";

const routeApi = getRouteApi("/_app/characters/$characterId/");
...
export function CharacterDetailPage() {
  ...
  const avatarUrl = avatarSrc(data.avatar, String(api.defaults.baseURL));
  const formValues = {
    spec: data.spec,
