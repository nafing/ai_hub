...
import { CreateGeneratorPresetModal } from "@/features/modals/generator-presets/CreateGeneratorPresetModal";
import {
...
import { CreatePresetModal } from "@/features/modals/presets/CreatePresetModal";
import { ImportPresetModal } from "@/features/modals/presets/ImportPresetModal";
import {
  useDeletePreset,
  useDuplicatePreset,
  usePresets,
...
import classes from "./PresetsPage.module.css";

const routeApi = getRouteApi("/_app/presets/");
...
export function PresetsPage() {
  const { category: navCategory } = routeApi.useSearch();
