...
import { PersonaForm } from "@/features/shared/personas/PersonaForm";
...
const routeApi = getRouteApi("/_app/personas/$personaId/");

const FORM_ID = "persona-edit-form";

export function PersonaDetailPage() {
  const { personaId } = routeApi.useParams();
  ...
  const avatarUrl = avatarSrc(avatar, String(api.defaults.baseURL));
