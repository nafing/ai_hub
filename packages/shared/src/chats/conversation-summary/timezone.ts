...
export function formatZonedConversationTime(
  date: Date,
  timeZone?: string,
): string {
...
export function formatZonedConversationDate(
  date: Date,
  timeZone?: string,
  rolloverHour = 0,
): string {
...
export function zonedLogicalDateKey(
  date: Date,
  timeZone?: string,
  rolloverHour = 0,
): string {
...
export function isSameZonedLogicalDay(
  a: Date,
  b: Date,
  timeZone?: string,
  rolloverHour = 0,
  ...
  return (
    zonedLogicalDateKey(a, timeZone, rolloverHour) ===
    zonedLogicalDateKey(b, timeZone, rolloverHour)
  );
}
